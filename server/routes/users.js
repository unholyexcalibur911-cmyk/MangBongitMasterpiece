...
router.get('/me', requireAuth, async (req, res) => {
  ...
  res.json({ email: user.email, name: user.name, role: user.role, isAdmin: user.role === 'admin' });
});
...
router.patch('/me', requireAuth, async (req, res) => {
  ...
  return res.json({ id: me.id, email: me.email, name: me.name, avatarUrl: me.avatarUrl });
});
